...
const Storage = multer.diskStorage(
    {
        destination : function(req , file , cb ){
            ...
            if(file.fieldname === 'circular_upload')
            {
                ...
                // cb(null , 'D:/JAY/WEB_DEVELOPMENT_CODE_WITH_HARRY/Node.js/OJAS/src/uploads/company/circular');                
            }
            
            else if(file.fieldname === 'verified_upload')
            {
                cb(null , '../public/uploads/company/verified');
                // cb(null , 'D:/JAY/WEB_DEVELOPMENT_CODE_WITH_HARRY/Node.js/OJAS/src/uploads/company/verified');                
            }
        },
